...
ALTER TABLE HoaDon ADD CONSTRAINT PK_HOADON PRIMARY KEY (MSDH)
ALTER TABLE DatHang ADD CONSTRAINT FK_MSDH FOREIGN KEY (MSDH) REFERENCES HoaDon(MSDH)
...
ALTER TABLE DatHang ADD CONSTRAINT FK_MSHH
	FOREIGN KEY (MSHH) REFERENCES ThucUong(MSHH)
ON DELETE CASCADE

ALTER TABLE HoaDon ADD CONSTRAINT FK_MSDH
	FOREIGN KEY (MSDH) REFERENCES DatHang(MSDH)
ON DELETE CASCADE

ALTER TABLE DatHang DROP CONSTRAINT FK_MSHH

ALTER TABLE HoaDon DROP CONSTRAINT FK_MSDH
